...
public class Money implements Comparable {
	...
	public String toString() {
		return (double)this.amount/100 + " " + this.getCurrency().getName();
	}
	...
	public Money add(Money other) {
		int firstConvert = this.universalValue();
		int secondConvert = other.universalValue();
		int sum = firstConvert + secondConvert;
		return new Money((int) (sum/this.getCurrency().getRate()), this.getCurrency());
	}
	...
	public Money sub(Money other) {
		double firstConvert = this.universalValue();
		double secondConvert = other.universalValue();
		double sub = firstConvert - secondConvert;
		return new Money((int)(sub/this.getCurrency().getRate()), this.getCurrency());
	}
